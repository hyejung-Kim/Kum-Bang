...
public class BoardEnrollServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher reqDispatcher = request.getRequestDispatcher("/WEB-INF/board/insertBoard.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		// RoomBoard객체로 만들기
		RoomBoard newRoomBoard = new RoomBoard(0, br_cp_id, board_title, content, null, 0, originalName, renameName,
				"F");
